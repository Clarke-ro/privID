...
export const HorizontalTabs = () => {
  ...
  return (
    <div className="bg-card/80 backdrop-blur-sm border border-border rounded-lg mx-6 my-4 p-2" style={{ backgroundColor: 'hsl(var(--tabs-bg))' }}>
      <div className="flex gap-1 overflow-x-auto">
        {tabs.map((tab) => (
          <Button
            ...
            className={cn(
              "px-6 py-2 text-sm font-medium whitespace-nowrap rounded-lg transition-all",
