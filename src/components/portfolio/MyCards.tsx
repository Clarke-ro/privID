...
export const MyCards = () => {
  ...
  return <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        return <Card key={card.id} className={`bg-gradient-to-br ${card.gradient} border-border hover:border-web3-orange/50 transition-all duration-300`}>
              <CardContent className="p-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {card.description && <p className="text-muted-foreground text-sm leading-relaxed">
                        {card.description}
                      </p>}
                  </div>
                  
                  <Button variant={card.buttonVariant} size="sm" className="w-full">
                    {card.buttonText}
                  </Button>
                </div>
              </CardContent>
